...
(start)
_arguments "${_arguments_options[@]}" : \
'--kind[Supported agent kind and canonical executable]:KIND:(pi claude codex gemini cursor devin agy cline omp mastracode opencode copilot kimi kiro droid amp grok hermes kilo qodercli maki)' \
...
&& ret=0
    ...
    (integration)
        ...
        case $line[1] in
            (install)
_arguments "${_arguments_options[@]}" : \
':target:(pi omp claude codex copilot devin droid kimi opencode kilo hermes qodercli cursor mastracode)' \
&& ret=0
;;
(uninstall)
_arguments "${_arguments_options[@]}" : \
